...
![Ubuntu 上の WaveKat Voice — アシスタントが発信した通話が進行中で、横にリアルタイムの文字起こしを表示。](/screenshots/in-call/ja.webp)
...
![Ubuntu 上の WaveKat Voice — コマンドライン アクセスを有効にした自動化設定と、コマンドラインツールをインストールするボタン。](/screenshots/settings-automation/ja.webp)
...
![Ubuntu 上の WaveKat Voice — Claude や Cursor などの AI アシスタントを、ワンクリックの「接続」ボタンで連携。](/screenshots/settings-automation-agents/ja.webp)

---
title: "通話録音をリンクで共有する"
description: "録音した通話をそのまま共有リンクに。非公開・招待制・公開から選べて、受け取った人が何を聞いて何を読めるかまで指定できます。"
date: 2026-06-28
author: Eason Guo
...
**実際に見てみる：** [本物の共有録音を開く →](https://platform.wavekat.com/voice/s/5EWJHKQ1zXamKB3ydxxPQA) —— 公開・音声のみで共有された通話が、受け取った人に見えるそのままの形で開きます。
...
WaveKat Voice は Mac・Windows・Linux で動作します。共有は対応する 3 つのプラットフォームで使え、受け取った人は任意の Web ブラウザで共有リンクを開けます。

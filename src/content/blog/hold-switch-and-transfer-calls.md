...
There's a **Hold** button on the call screen, between Mute and the keypad. Press it and the call pauses in both directions: you can't hear them, they can't hear you, and — because everything in WaveKat Voice stays truthful — the recording and the live transcript pause too. Nothing said near your desk while a call is parked ends up in the transcript.

---
title: "Common Voice Explorer — ascolta le voci del mondo"
description: "Sfoglia, cerca e ascolta migliaia di voci umane reali da Mozilla Common Voice — direttamente nel tuo browser. Nessun download, nessuna configurazione."
date: 2026-04-21
author: Eason Guo
tags: [strumenti, dati-aperti, voice-ai]
lang: "it"
---

Se ti sei mai chiesto come suonino migliaia di voci umane reali — età, accenti e lingue diversi — esiste un dataset per questo. Si chiama [Mozilla Common Voice](https://commonvoice.mozilla.org) ed è una delle più grandi raccolte aperte di parlato registrato al mondo.
...
[Common Voice Explorer](https://commonvoice-explorer.wavekat.com) è un semplice strumento web che ti permette di sfogliare il dataset direttamente nel browser. Nessun download, nessuno script, nessuna configurazione.

![Common Voice Explorer — cerca, filtra e ascolta le clip direttamente nel browser](/blog/01-common-voice-explorer.png)
...
Common Voice Explorer è online su [commonvoice-explorer.wavekat.com](https://commonvoice-explorer.wavekat.com). Accedi con GitHub, accetta i termini d’uso e inizia a esplorare.

C’è anche una breve [demo su YouTube](https://youtu.be/8IScEH0ZJxA) se vuoi prima vederlo in azione.

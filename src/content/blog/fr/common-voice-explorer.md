...
Si vous vous êtes déjà demandé à quoi ressemblent des milliers de voix humaines réelles — différents âges, accents, langues — il existe un jeu de données pour ça. Il s'appelle [Mozilla Common Voice](https://commonvoice.mozilla.org), et c'est l'une des plus grandes collections ouvertes d'enregistrements de parole au monde.
...
[Common Voice Explorer](https://commonvoice-explorer.wavekat.com) est un outil web simple qui vous permet de parcourir le jeu de données directement dans votre navigateur. Aucun téléchargement, aucun script, aucune configuration.

![Common Voice Explorer — recherchez, filtrez et écoutez des clips directement dans le navigateur](/blog/01-common-voice-explorer.png)
...
Common Voice Explorer est en ligne à l'adresse [commonvoice-explorer.wavekat.com](https://commonvoice-explorer.wavekat.com). Connectez-vous avec GitHub, acceptez les conditions d'utilisation et commencez à explorer.

Il y a aussi une courte [démo sur YouTube](https://youtu.be/8IScEH0ZJxA) si vous voulez d'abord la voir en action.

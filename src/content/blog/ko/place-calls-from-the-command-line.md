...
![Ubuntu의 WaveKat Voice — 어시스턴트가 건 통화가 진행 중이며 옆에 실시간 자막이 표시됩니다.](/screenshots/in-call/ko.webp)
...
![Ubuntu의 WaveKat Voice — 명령줄 액세스가 켜진 자동화 설정과 명령줄 도구 설치 버튼.](/screenshots/settings-automation/ko.webp)
...
![Ubuntu의 WaveKat Voice — Claude와 Cursor 같은 AI 어시스턴트를 원클릭 연결 버튼으로 연결합니다.](/screenshots/settings-automation-agents/ko.webp)

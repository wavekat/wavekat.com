---
title: "Common Voice Explorer — Escuche las voces del mundo"
description: "Explore, busque y escuche miles de voces humanas reales de Mozilla Common Voice, directamente en su navegador. Sin descargas, sin configuración."
date: 2026-04-21
author: Eason Guo
tags: [herramientas, datos-abiertos, voz-ia]
lang: "es"
---

Si alguna vez se ha preguntado cómo suenan miles de voces humanas reales —distintas edades, acentos, idiomas—, existe un conjunto de datos para ello. Se llama [Mozilla Common Voice](https://commonvoice.mozilla.org) y es una de las mayores colecciones abiertas de habla grabada del mundo.
...
[Common Voice Explorer](https://commonvoice-explorer.wavekat.com) es una sencilla herramienta web que le permite explorar el conjunto de datos directamente en su navegador. Sin descargas, sin scripts, sin configuración.

![Common Voice Explorer — busque, filtre y escuche clips directamente en el navegador](/blog/01-common-voice-explorer.png)
...
Common Voice Explorer está disponible en [commonvoice-explorer.wavekat.com](https://commonvoice-explorer.wavekat.com). Inicie sesión con GitHub, acepte los términos de uso y empiece a explorar.

También hay una breve [demostración en YouTube](https://youtu.be/8IScEH0ZJxA) por si primero quiere verlo en acción.

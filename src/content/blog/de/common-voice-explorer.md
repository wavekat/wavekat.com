...
date: 2026-04-21
author: Eason Guo
tags: [Werkzeuge, Open-Data, Sprach-KI]
lang: "de"
---

Wenn Sie sich je gefragt haben, wie Tausende echter menschlicher Stimmen klingen — unterschiedliche Altersgruppen, Akzente, Sprachen — dann gibt es dafür einen Datensatz. Er heißt [Mozilla Common Voice](https://commonvoice.mozilla.org) und ist eine der größten offenen Sammlungen aufgezeichneter Sprache der Welt.
...
[Common Voice Explorer](https://commonvoice-explorer.wavekat.com) ist ein einfaches Web-Werkzeug, mit dem Sie den Datensatz direkt im Browser durchstöbern können. Kein Download, keine Skripte, keine Einrichtung.

![Common Voice Explorer — Clips direkt im Browser suchen, filtern und anhören](/blog/01-common-voice-explorer.png)
...
Common Voice Explorer ist live unter [commonvoice-explorer.wavekat.com](https://commonvoice-explorer.wavekat.com). Melden Sie sich mit GitHub an, akzeptieren Sie die Nutzungsbedingungen und legen Sie los.

Es gibt außerdem eine kurze [Demo auf YouTube](https://youtu.be/8IScEH0ZJxA), falls Sie es zuerst in Aktion sehen möchten.

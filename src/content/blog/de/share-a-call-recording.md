...
**Sehen Sie es selbst:** [eine echte geteilte Aufnahme öffnen →](https://platform.wavekat.com/voice/s/5EWJHKQ1zXamKB3ydxxPQA) — ein öffentlich, nur als Audio geteilter Anruf, genau so, wie ihn ein Empfänger sieht (die Seite ist auf Englisch).

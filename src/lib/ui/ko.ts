...
export const ui: UIStrings = {
  ...
  dlWindowsX64: 'Intel 또는 AMD용 Windows',
  dlWindowsArm64: 'ARM용 Windows',
  dlOther: '다른 플랫폼',
  dlArchMac: 'Apple 실리콘 탑재 Mac (M1 이상)',
  dlArchLinux: 'Debian 및 Ubuntu (.deb, 64비트)',
  dlArchWindowsX64: 'Windows 10 및 11, 64비트',
  dlArchWindowsArm64: 'Snapdragon 또는 Surface의 Windows 11',
  dlEarly: '초기 버전',
  dlWindowsUnsigned:

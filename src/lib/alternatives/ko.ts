...
export const alternatives: Alternative[] = [
  {
    ...
    seoTitle: 'WaveKat Voice — Mac 및 Linux용 Linphone 대안',
    seoDescription:
      'WaveKat Voice와 Linphone을 Mac 및 Linux에서 비교합니다. 모든 통화를 자동으로 녹음하고 전사하며, 안내에 따라 통신사를 설정하는 집중형 업무용 전화. 무료 공개 베타.',

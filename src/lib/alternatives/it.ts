...
export const alternatives: Alternative[] = [
  {
    ...
    seoDescription:
      'Come WaveKat Voice si confronta con Linphone su Mac e Linux: un telefono aziendale che registra e trascrive ogni chiamata, con setup guidato.',

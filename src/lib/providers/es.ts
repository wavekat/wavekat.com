...
export const providers: Provider[] = [
  {
    ...
    seoDescription:
      'Use su número 2talk en Mac o Linux con WaveKat Voice: un softphone SIP sin suscripción que graba y transcribe cada llamada. Alternativa gratuita a Bria para 2talk.',
